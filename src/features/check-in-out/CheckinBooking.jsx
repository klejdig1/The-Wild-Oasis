  ...
  return (
    <>
      ...
      <BookingDataBox booking={booking} />
        ...
        <Box>
            <Checkbox checked={confirmPaid} disabled={confirmPaid} onChange={()=>setConfirmPaid(confirm=> !confirm)} id='confirm'>I confirm that {guests.fullName} has paid total amount of {!addBreakfast ? formatCurrency(totalPrice) :`${formatCurrency(totalPrice + optionalBreakfastPrice)} (${formatCurrency(totalPrice)} + ${formatCurrency(optionalBreakfastPrice)})`}</Checkbox>
        </Box>
