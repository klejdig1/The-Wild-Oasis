      ...
      <Amount>{formatCurrency(totalPrice)}</Amount>
        ...
        <Menus>
            ...
            <Menus.List id={bookingId}>
                ...
                {status === 'checked-in' &&
                    <Menus.Button onClick={() =>checkout({bookingId})} disabled={isCheckinOut} icon={<HiArrowUpOnSquare/>}>Check out</Menus.Button>
                }
            ...
            <Modal.Window name='delete'>
                <ConfirmDelete disabled={isDeleting} resourceName='booking' onConfirm={()=>deleteBookingItem(bookingId)} onCloseModal={''} />
            </Modal.Window>
        </Modal>
    </Table.Row>
  );
